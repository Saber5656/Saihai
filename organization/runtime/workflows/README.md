...
This directory is the P0 contract surface for the TAKT-based agent orchestrator.
...
| `scripts/takt_workflow_selector.py` | Deterministic selector and activation-envelope helper |
| `tests/test_takt_workflow_selector.py` | Unit/static contract tests |
...
```sh
python3 organization/runtime/workflows/scripts/takt_workflow_selector.py validate-contracts
