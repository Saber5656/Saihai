...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| business-director | business | active | false | openai | gpt-5.6-luna |  | codex | medium | medium |  | 上流判断、対外説明、法務リスク、レビュー線調整を安定して扱うため(2026-08-31: Luna Max routing policy.) |
| business-information-strategy | business | active | false | openai | gpt-5.6-luna |  | codex | high | high |  | 複雑な情報整理、比較軸、意思決定材料の0→1設計を強化するため(2026-08-31: Luna Max routing policy.) |
| business-legal-reviewer | business | active | false | openai | gpt-5.6-luna |  | codex | medium | medium |  | Business Director が必要時に起動する専門メンバー(2026-08-31: Luna Max routing policy.) |
...
| business-partnership-manager | business | active | false | openai | gpt-5.6-luna |  | codex | medium | medium |  | Business Director が必要時に起動する専門メンバー(2026-08-31: Luna Max routing policy.) |
| business-strategy | business | active | false | openai | gpt-5.6-luna |  | codex | high | high |  | 事業上の0→1判断、優先順位、選択肢設計を強化するため(2026-08-31: Luna Max routing policy.) |
| contents-director | contents | active | false | openai | gpt-5.6-luna |  | codex | medium | medium |  | 文脈理解、読者適合、品質基準、チーム内レビュー線の整理を安定して扱うため(2026-08-31: Luna Max routing policy.) |
| contents-formatter | contents | active | false | openai | gpt-5.6-luna |  | codex | medium | medium |  | Contents Director が必要時に起動する専門メンバー(2026-08-31: Luna Max routing policy.) |
| contents-quality-manager | contents | active | false | openai | gpt-5.6-luna |  | codex | medium | medium |  | Contents Director が必要時に起動する専門メンバー(2026-08-31: Luna Max routing policy.) |
| contents-researcher | contents | active | false | openai | gpt-5.6-luna |  | codex | high | high |  | 記事化・要約・説明の前提調査で網羅性と正確性を最優先するため(2026-08-31: Luna Max routing policy.) |
| gate-prompt-formatter | gate | active | true | openai | gpt-5.6-luna |  | codex | medium | medium |  | 日本語の曖昧な依頼から意図、完了条件、範囲、暗黙の制約を高精度に構造化する役割のため(2026-08-31: Luna Max routing policy.) |
...
| gate-task-creator | gate | active | false | openai | gpt-5.6-luna |  | codex | low | low |  | 2026-06-14: 既定入口は GPF report -> `gtc-scaffold` command -> TPM queue へ移行。GTC provider は legacy / recovery fallback のみ lazy activation し、初期 hook では起動しない(2026-08-31: Luna Max routing policy.) |
| gate-task-evaluator | gate | active | true | openai | gpt-5.6-luna |  | codex | medium | medium |  | 2026-06-13: TPM の `team-completion-check` 通過後に queue activation で起動する。要求充足、レビュー結果、検証結果、Git 差分の関係を横断判断するため(2026-08-31: Luna Max routing policy.) |
...
| teams-project-manager | gate | active | true | openai | gpt-5.6-luna |  | codex | medium | medium |  | Gate 起票後の組織横断ルーティング、レビュー線、実行順序を扱う(2026-08-31: Luna Max routing policy.) |
...
| tech-tester | tech | active | false | openai | gpt-5.6-luna |  | codex | medium | medium |  | Tech Director が必要時に起動する専門メンバー（2026-08-31: Luna Max routing policy） |
