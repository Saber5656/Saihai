...
| Output Agents | infra worker/tool-adjacent roles, then `gate-task-assessor` after Completion Report |
...
10. 全 team task 完了後、Completion Report を作成して `gate-task-assessor` へ渡す。
