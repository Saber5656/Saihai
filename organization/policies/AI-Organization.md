...
| Team membership | `Agent-Teams-Viewer/organization/runtime/infra-team-bootstrap/config/role-agent-registry.yaml` | Organization Instance で起動・待機対象になる role を定義する |
| Model / provider | `Agent-Teams-Viewer/organization/runtime/infra-team-bootstrap/references/model-registry.md` | `intended_model`、provider、execution mode を定義する |
...
- Team Role のモデル設定は `~/skills-repo/Agent-Teams-Viewer/organization/runtime/infra-team-bootstrap/references/model-registry.md` を正本にする
