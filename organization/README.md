...
| `runtime/workflows/` | TAKT P0 workflow contracts, schemas, deterministic selector, and initial workflow template |
...
`runtime/workflows/` stores the first TAKT-based orchestrator contract surface.
